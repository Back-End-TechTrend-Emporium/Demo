...
namespace External.FakeStore.Mappers
{
    ...
    /// Este mapper crea entidades que luego necesitar�n ser persistidas con ExternalMapping
    /// </summary>
    public static class FakeStoreMapper
    {
        public static Product ToProduct(this FakeStoreProductResponse fakeStoreProduct)
        {
            return new Product
            {
                ...
                // CategoryId y CreatedBy necesitar�n ser establecidos por el servicio que use este mapper
            };
        }
        ...
        public static Cart ToCart(this FakeStoreCartResponse fakeStoreCart)
        {
            var cart = new Cart
            {
                UserId = Guid.NewGuid(), // Necesitar�as resolver esto al UserId interno real
                CreatedAt = DateTime.UtcNow,
                UpdatedAt = DateTime.UtcNow
            };
            ...
            {
                ProductId = Guid.NewGuid(), // Necesitar�as resolver esto desde ExternalMapping
                Quantity = p.Quantity,
                Cart = cart,
                CreatedAt = DateTime.UtcNow
            }).ToList();
